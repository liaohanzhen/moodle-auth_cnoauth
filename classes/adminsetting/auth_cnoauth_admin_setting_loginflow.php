 ...
 */
class auth_cnoauth_admin_setting_loginflow extends \admin_setting {
    ...
    public function output_html($data, $query = '') {
        ...
        foreach ($this->flowtypes as $flowtype) {
            ...
            $typename = get_string('cfg_loginflow_'.$flowtype, 'auth_cnoauth');
            $typedesc = get_string('cfg_loginflow_'.$flowtype.'_desc', 'auth_cnoauth');
