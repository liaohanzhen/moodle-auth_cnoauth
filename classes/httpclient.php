...
/**
 * Implementation of \auth_cnoauth\httpclientinterface using Moodle CURL.
 */
class httpclient extends \curl implements \auth_cnoauth\httpclientinterface {
    /**
    ...
    protected function get_plugin_version() {
        global $CFG;
        $plugin = new \stdClass;
        require_once($CFG->dirroot.'/auth/cnoauth/version.php');
