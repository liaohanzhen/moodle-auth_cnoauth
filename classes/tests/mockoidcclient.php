...
namespace auth_cnoauth\tests;

/**
 * A mock cnoauthclient class providing access to all inaccessible properties/methods.
 */
class mockcnoauthclient extends \auth_cnoauth\cnoauthclient {
