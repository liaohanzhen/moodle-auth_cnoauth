...
$string['auth_cnoauthdescription'] = 'The OpenID Connect plugin provides single-sign-on functionality using configurable identity providers.';
...
$string['cfg_cnoauthresource_desc'] = 'The OpenID Connect resource for which to send the request.';
...
$string['cfg_cleanupcnoauthtokens_key'] = 'Cleanup OpenID Connect Tokens';
$string['cfg_cleanupcnoauthtokens_desc'] = 'If your users are experiencing problems logging in using their Microsoft 365 account, trying cleaning up OpenID Connect tokens. This removes stray and incomplete tokens that can cause errors. WARNING: This may interrupt logins in-process, so it\'s best to do this during downtime.';
...
$string['errorcnoauthnotenabled'] = 'The OpenID Connect authentication plugin is not enabled.';
...
$string['errorcnoauthcall'] = 'Error in OpenID Connect. Please check logs for more information.';
$string['errorcnoauthcall_message'] = 'Error in OpenID Connect: {$a}';
...
$string['cnoauth:manageconnection'] = 'Allow OpenID Connection and Disconnection';
$string['cnoauth:manageconnectionconnect'] = 'Allow OpenID Connection';
$string['cnoauth:manageconnectiondisconnect'] = 'Allow OpenID Disconnection';

$string['privacy:metadata:auth_cnoauth'] = 'OpenID Connect Authentication';
...
$string['privacy:metadata:auth_cnoauth_token'] = 'OpenID Connect tokens';
...
$string['privacy:metadata:auth_cnoauth_token:idtoken'] = 'The ID token';
...
$string['cleanup_cnoauth_tokens'] = 'Cleanup OpenID Connect tokens';
