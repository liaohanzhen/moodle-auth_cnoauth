 ...
 * @group office365
 */
class auth_cnoauth_cnoauthclient_testcase extends \advanced_testcase {
    /**
    ...
    public function test_creds_getters_and_setters() {
        $httpclient = new \auth_cnoauth\tests\mockhttpclient();
        $client = new \auth_cnoauth\tests\mockcnoauthclient($httpclient);
